...
def music_background():
    ...
    """
    pygame.mixer.music.load('Pygame/game_sounds/background_music.mp3')
...
def show_game_over(screen, score): 
    ...
    pygame.display.flip()
    pygame.mixer.music.load('Pygame/game_sounds/gameover.mp3') 
...
def show_game_win(screen):
    ...
    pygame.display.flip() 
    pygame.mixer.music.load('Pygame/game_sounds/win.mp3') 
    pygame.mixer.music.play() 
