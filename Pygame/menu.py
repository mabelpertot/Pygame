...
def music_background():
    ...
    pygame.mixer.music.load("Pygame/game_sounds/menu.mp3")
...
mainmenu_img = pygame.image.load('Pygame/images/mainmenu.jpg').convert() 
mainmenu_img = pygame.transform.scale(mainmenu_img, (WIDTH, HEIGHT)) 

logo_img = pygame.image.load('Pygame/images/xxx.jpg').convert_alpha() 
...
pygame.mixer.music.load('Pygame/game_sounds/menu.mp3') 
pygame.mixer.music.play(-1) 
explosion_sound = pygame.mixer.Sound('Pygame/game_sounds/explosions/explosion1.wav') 
